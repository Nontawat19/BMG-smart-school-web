...
import {
  ...
  ACADEMIC_ACCESS,
  STAFF_ACCESS,
  GENERAL_AFFAIRS_ACCESS,
  GENERAL_AFFAIRS_WORK_ACCESS,
  ACADEMIC_MANAGEMENT,
  TEACHER_OPERATIONAL,
...
export const ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { key: 'checkin_out',                path: '/attendance/checkin-out',                label: 'เช็คอิน/เช็คเอาท์',             category: 'ลางานและเวลา', defaultRoles: [...STAFF_ACCESS, ROLES.SUPER_ADMIN, ROLES.STUDENT_ATTENDANCE, ROLES.TEACHER_ATTENDANCE, ROLES.SCHOOL_ATTENDANCE] },
  ...
  // ──────────────────────────────── งานธุรการและสารบรรณ ────────────────────────────────
  { key: 'general_affairs_home',     path: '/general-affairs/home',     label: 'หน้าหลักระบบงานธุรการโรงเรียน',               category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_WORK_ACCESS, defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
  { key: 'general_affairs',          path: '/general-affairs',          label: 'ประทับตรารับเอกสาร (สารบรรณอิเล็กทรอนิกส์)',  category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_ACCESS,      defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
  { key: 'director_assignments',     path: '/director/assignments',     label: 'เอกสารรอมอบหมาย (ผอ.)',                     category: 'งานธุรการและสารบรรณ', defaultRoles: [ROLES.SCHOOL_ADMIN, ROLES.DIRECTOR, ROLES.DEPT_HEAD], defaultDepartments: ['งานบริหารทั่วไป', 'ฝ่ายบริหาร'] },
  { key: 'director_assigned_work',   path: '/director/assigned-work',   label: 'ธุรการมอบหมายแล้ว (งานที่ได้รับมอบหมาย)',    category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_WORK_ACCESS, defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
  { key: 'general_affairs_news',     path: '/general-affairs/news',     label: 'จัดการข่าวสารประชาสัมพันธ์',                 category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_ACCESS,      defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
  { key: 'general_affairs_registry', path: '/general-affairs/registry', label: 'ทะเบียนหนังสือ (รับ/ส่ง/คำสั่ง/ประกาศ)',     category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_ACCESS,      defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
  ...
  { key: 'student_behavior',    path: '/school/:schoolId/students/behavior',           label: 'คะแนนพฤติกรรมนักเรียน',        category: 'ข้อมูลนักเรียน', defaultRoles: [...STUDENT_AFFAIRS_ACCESS, ROLES.TEACHER] },
  ...
  { key: 'student_support_sdq_student',    path: '/student-support/sdq/student',                  label: 'แบบประเมิน SDQ (นักเรียน)',       category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: [ROLES.STUDENT, ...STUDENT_SUPPORT_OPERATIONAL_ACCESS] },
  { key: 'student_support_sdq_teacher',    path: '/student-support/sdq/teacher',                  label: 'แบบประเมิน SDQ (ครู)',           category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_SUPPORT_OPERATIONAL_ACCESS },
  { key: 'student_support_sdq_parent',     path: '/student-support/sdq/parent',                   label: 'แบบประเมิน SDQ (ผู้ปกครอง)',     category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_SUPPORT_OPERATIONAL_ACCESS },
  ...
  { key: 'student_support_screen_student', path: '/student-support/screening/student',            label: 'คัดกรองนักเรียน (ฉบับนักเรียน)',   category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: [ROLES.STUDENT, ...STUDENT_SUPPORT_OPERATIONAL_ACCESS] },
  { key: 'student_support_screen_teacher', path: '/student-support/screening/teacher',            label: 'คัดกรองนักเรียน (ฉบับครู)',       category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_SUPPORT_OPERATIONAL_ACCESS },
  { key: 'student_support_screen_parent',  path: '/student-support/screening/parent',             label: 'คัดกรองนักเรียน (ฉบับผู้ปกครอง)', category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_SUPPORT_OPERATIONAL_ACCESS },
  ...
  { key: 'student_support_home_visit_new', path: '/student-support/home-visit/new/:studentId',    label: 'บันทึกการเยี่ยมบ้านรายบุคคล',      category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_SUPPORT_OPERATIONAL_ACCESS },
  { key: 'behavior_score_analysis',        path: '/student-support/behavior-analysis',            label: 'วิเคราะห์คะแนนความประพฤติ',       category: 'ดูแลช่วยเหลือนักเรียน', defaultRoles: STUDENT_AFFAIRS_ACCESS },
  ...
  { key: 'course_enrollment_scoped', path: '/school/:schoolId/academic/course-enrollment', label: 'ลงทะเบียนรายวิชา (ระบุโรงเรียน)', category: 'วิชาการ - ทะเบียน', defaultRoles: ACADEMIC_MANAGEMENT },
  ...
  { key: 'special_period_attendance', path: '/academic/special-period-attendance',    label: 'เช็คชื่อคาบพิเศษ/กิจกรรม',    category: 'วิชาการ - เช็คชื่อ', defaultRoles: TEACHER_OPERATIONAL },
  { key: 'student_time_registration', path: '/academic/student-time-registration',    label: 'ลงเวลาเรียนนักเรียน (สแกน)',  category: 'วิชาการ - เช็คชื่อ', defaultRoles: STUDENT_AFFAIRS_ACCESS },
  ...
  { key: 'score_configuration',    path: '/academic/score-configuration',          label: 'ตั้งค่าคะแนนเต็มรายวิชา',    category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: TEACHER_OPERATIONAL },
  { key: 'sgs_export',             path: '/academic/sgs-export',                   label: 'ส่งออกคะแนน (SGS)',           category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: TEACHER_OPERATIONAL },
  { key: 'remediation_requests',   path: '/academic/remediation-requests',         label: 'รายการคำร้องขอแก้ผลการเรียน',   category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: [...TEACHER_OPERATIONAL, ...ACADEMIC_MANAGEMENT] },
  { key: 'remediation_overview',   path: '/academic/remediation-overview',         label: 'ภาพรวมการแก้ 0 ร มส',         category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: ACADEMIC_MANAGEMENT },
  { key: 'remediation_record',     path: '/academic/remediation-record',           label: 'บันทึกผลการแก้ 0 ร มส',       category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: [...TEACHER_OPERATIONAL, ...ACADEMIC_MANAGEMENT] },
  { key: 'attendance_ms_backfill', path: '/academic/attendance-ms-backfill',       label: 'ตรวจสอบ มส. ย้อนหลัง (เวลาเรียน)', category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: ACADEMIC_MANAGEMENT },
  { key: 'my_grade_flags',         path: '/my-grade-flags',                        label: 'ติดตามผลการติด 0 ร มส',       category: 'วิชาการ - คะแนนและประเมิน', defaultRoles: [...STAFF_ACCESS, ROLES.STUDENT] },
  ...
  { key: 'remediation_settings',     path: '/academic/remediation-settings',  label: 'ตั้งค่าการแก้ 0 ร มส',   category: 'วิชาการ - ตั้งค่า', defaultRoles: ACADEMIC_MANAGEMENT },
  ...
  { key: 'owner_schools_scoped',      path: '/owner/schools/:schoolId',          label: 'รายละเอียดโรงเรียน (Owner)', category: 'ผู้ดูแลระบบ', defaultRoles: OWNER_ONLY },
  { key: 'owner_school_data',         path: '/owner/schools/:schoolId/data',     label: 'Data Explorer (Owner)',    category: 'ผู้ดูแลระบบ', defaultRoles: OWNER_ONLY },
  { key: 'owner_users',               path: '/owner/users',                      label: 'ผู้ใช้งานระบบ',             category: 'ผู้ดูแลระบบ', defaultRoles: [ROLES.SUPER_ADMIN, ...ADMIN_ACCESS] },
  { key: 'owner_users_edit',          path: '/owner/users/edit/:userId',         label: 'แก้ไขผู้ใช้งานระบบ (Owner)', category: 'ผู้ดูแลระบบ', defaultRoles: [ROLES.SUPER_ADMIN, ...ADMIN_ACCESS] },
  ...
  { key: 'owner_manuals',             path: '/owner/manuals',                    label: 'จัดการคู่มือการใช้งาน (Owner)', category: 'ผู้ดูแลระบบ', defaultRoles: OWNER_ONLY },
  { key: 'owner_ai_settings',         path: '/owner/ai-settings',                label: 'ตั้งค่าผู้ช่วย AI',         category: 'ผู้ดูแลระบบ', defaultRoles: OWNER_ONLY },
];
