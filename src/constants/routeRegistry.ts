...
export const ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { key: 'general_affairs',          path: '/general-affairs',          label: 'หนังสือรับ (ประทับตรา)',  category: 'งานธุรการและสารบรรณ', defaultRoles: GENERAL_AFFAIRS_ACCESS,      defaultDepartments: ['งานบริหารทั่วไป'], defaultSpecialRoles: ['isGeneralAffairsOfficer'] },
