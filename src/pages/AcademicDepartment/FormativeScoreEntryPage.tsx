...
=======
                [studentId]: { ...current, midterm: numValue }
>>>>>>> 5f8c7e1 (feat: optimize auto-scheduler and update UI labels)
            };
        });
    };
...
=======
        const formativeTotal = activeAssessments.reduce((sum, a) => sum + (details[a.id] || 0), 0);
        const part1Total = formativeTotal + (record.midterm || 0);
>>>>>>> 5f8c7e1 (feat: optimize auto-scheduler and update UI labels)
...
=======
                                            <th colSpan={activeAssessments.length} className="px-2 py-2 text-center bg-indigo-500/5 text-indigo-600 dark:text-indigo-400 border-b border-slate-200 dark:border-white/5 border-r border-slate-200 dark:border-white/5">
>>>>>>> 5f8c7e1 (feat: optimize auto-scheduler and update UI labels)
...
=======
                                                    <td className={`px-1 py-1 border-r border-slate-200 dark:border-white/5 ${ (record.midterm || 0) > (currentCourse?.midtermWeight || 20) ? 'bg-red-500/10' : 'bg-emerald-500/[0.02]' }`}>
>>>>>>> 5f8c7e1 (feat: optimize auto-scheduler and update UI labels)
                                                        <input 
                                                            type="text"
...
=======
                                                                (record.midterm || 0) > (currentCourse?.midtermWeight || 20) ? 'text-red-500' : 'text-emerald-600 dark:text-emerald-400'
>>>>>>> 5f8c7e1 (feat: optimize auto-scheduler and update UI labels)
                                                            }`}
                                                            placeholder="0"
                                                        />
