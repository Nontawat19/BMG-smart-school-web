            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                {selectedTeacher && (
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-500 hover:bg-amber-500/20 transition-all text-[10px] font-black uppercase tracking-widest shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <button
                    ...
                    disabled={isAutoScheduling}
                    className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-indigo-600 text-white text-[11px] font-black uppercase tracking-widest shadow-lg hover:bg-indigo-500 hover:scale-[1.02] transition-all group disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
