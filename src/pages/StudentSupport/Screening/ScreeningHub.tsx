...
const ScreeningHub: React.FC = () => {
    return (
        <MainLayout>
            <div className="p-8 bg-gray-50 dark:bg-[#1e1f21] min-h-screen transition-colors duration-300">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Link to="/student-support/screening/teacher" className="group relative bg-white dark:bg-[#2a2b2f] p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center border-none outline-none ring-0 hover:no-underline transform-gpu">
                        ...
                        <Link to="/student-support/screening/student" className="group relative bg-white dark:bg-[#2a2b2f] p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center border-none outline-none ring-0 hover:no-underline transform-gpu">
                        ...
                        <Link to="/student-support/screening/parent" className="group relative bg-white dark:bg-[#2a2b2f] p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center border-none outline-none ring-0 hover:no-underline transform-gpu">
