                        ...
                        <div className="flex flex-wrap items-center gap-3 p-4 bg-white dark:bg-[#2a2b2f]/80 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 backdrop-blur-sm">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-gray-50 dark:bg-[#1e1f21] border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 py-2 pl-4 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500"
                                >
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-gray-50 dark:bg-[#1e1f21] border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 py-2 pl-4 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 min-w-[100px]"
                                >
