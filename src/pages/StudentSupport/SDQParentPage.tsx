        ...
        <MainLayout>
            <div className="p-4 sm:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                        <div>
                            ...
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                                ...
                                ผู้ปกครองประเมินนักเรียน (SDQ)
                            </h1>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">
                                ประเมิน SDQ โดยผู้ปกครอง
                            </p>
                        </div>

                        <div className="flex flex-wrap gap-3">
                            <div className="relative flex items-center bg-pink-50 dark:bg-pink-900/20 px-4 py-2 rounded-xl text-pink-700 dark:text-pink-300 font-bold border border-pink-100 dark:border-pink-800">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 py-2 pl-4 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500"
                                >
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 py-2 pl-4 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 min-w-[100px]"
                                >
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                    {displayedStudents.length > 0 ? displayedStudents.map((student) => {
                                        ...
                                        const pAssess = studentAssessments.find(a => a.evaluatorType === 'parent');
                                        const hasAssessed = !!pAssess;
                                        ...
                                        return (
                                            <tr key={student.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                                ...
                                                <td className="p-4 text-center">
                                                    {hasAssessed && pAssess?.interpretation ? (
                                                        <span className={`inline-block px-3 py-1 rounded-lg text-xs font-bold 
                                            ${pAssess.interpretation.total === 'ปกติ' ? 'bg-green-100 text-green-700' :
                                                                pAssess.interpretation.total === 'เสี่ยง' ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700'}
                                         `}>
                                                            {pAssess.interpretation.total} ({pAssess.totalDifficultyScore})
                                                        </span>
                                                    ) : '-'}
                                                </td>
                                                <td className="p-4 text-center">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 rounded-lg bg-pink-50 text-pink-600 font-medium text-sm hover:bg-pink-100 transition-colors"
                                                    >
                ...
                <SDQAssessmentModal
                    ...
                    evaluatorType="parent"
                    initialData={currentStudent && assessments[currentStudent.id]?.find(a => a.evaluatorType === 'parent')}
