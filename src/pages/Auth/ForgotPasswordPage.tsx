      ...
      <div className="w-full max-w-5xl bg-white dark:bg-[#1f2937] rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row h-auto max-h-full lg:h-auto animate-fadeIn">
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center relative">
          ...
          <div className="mb-6 text-center lg:text-left">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-2">ลืมรหัสผ่าน</h2>
            <p className="text-gray-500 dark:text-gray-400">ระบุอีเมลของคุณเพื่อรับลิงก์รีเซ็ตรหัสผ่าน</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? 'กำลังส่งข้อมูล...' : (
                <>
                  ส่งลิงก์รีเซ็ตรหัสผ่าน <FaArrowRight className="text-sm" />
                </>
              )}
            </button>
          </form>
